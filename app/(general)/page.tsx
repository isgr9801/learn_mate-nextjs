...
export default async function Page() {
	return (
		<>
			<main className="hero h-[calc(70vh)] bg-[#ffffff] relative">
				<div className="hero-content text-center mt-8 sm:mt-0">
					<div className="max-w-screen-md mb-44">
						<h1 className="text-3xl md:text-5xl font-bold text-black-primary">
							Learn-Mate
						</h1>
						<p className="py-6">
			...
			<section className="w-full px-4 py-8 flex justify-evenly flex-col sm:flex-row bg-white text-black">
				...
				<div className="flex flex-col items-center justify-center text-center md:text-left mt-8 sm:mt-0">
					<p className="text-lg leading-relaxed text-[#343446] max-w-sm">
						We believe that creating the future the world wants requires
						changing how the world grows. That's why we develop inclusive
						products for the people which are accessible and user-friendly.
					</p>
					<p className="mt-5 text-lg text-[#343446] max-w-sm">
						Led by the team of fantastic front-end developers, outstanding
						backend developers and phenomenal designers is creating
						next-generation solutions that will overcome critical challenges
						facing the industry.
					</p>
				</div>
			</section>
			<section
				id="contact"
				className="container mx-auto px-6 py-12 h-full flex flex-col md:flex-row justify-evenly items-center text-white"
			>
