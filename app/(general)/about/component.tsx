...
const AboutPage = () => {
	return (
		<section
			className="bg-black-primary text-white mt-[15vh] md:mt-[25vh]"
			id="about"
		>
			<div className="py-8 container mx-auto">
				<div className="container mx-auto px-4 text-center max-w-screen-lg">
					<p className="text-lg mb-4">
						LearnMate is a platform designed to enhance collaboration and
					...
					<p className="text-lg">
						Join LearnMate today and revolutionize the way you study!
					</p>
